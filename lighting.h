...
const QVector3D INIT_LIGHT_LA = QVector3D(0.03, 0.03, 0.03);    // »сходна€ интенсивность фонового света
const QVector3D INIT_LIGHT_LD = QVector3D(0.3, 0.3, 0.3);       // »сходна€ интенсивность рассе€нного света
const QVector3D INIT_LIGHT_LS = QVector3D(0.003, 0.003, 0.003); // »сходна€ интенсивность отраженного света
